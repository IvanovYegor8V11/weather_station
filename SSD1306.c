...
uint8_t Sym_1[6] = {0x00, 0x42, 0x7F, 0x40, 0x00, 0x00};				// 1
...
uint8_t Sym_A[6] = {0x46, 0x26, 0x10, 0xC8, 0xC4, 0x00};				// %
uint8_t Sym_B[6] = {0x7F, 0x09, 0x09, 0x09, 0x06, 0x00};				// P
uint8_t Sym_C[6] = {0x3E, 0x41, 0x41, 0x41, 0x22, 0x00};				// C
uint8_t Sym_D[6] = {0x7F, 0x08, 0x08, 0x08, 0x7F, 0x00};				// H
uint8_t Sym_E[6] = {0x24, 0x24, 0x24, 0x24, 0x24, 0x00};				// =
uint8_t Sym_T[6] = {0x01, 0x01, 0x7F, 0x01, 0x01, 0x00};				// T
uint8_t Sym_Point[2] = {0x80, 0x00};                                    // .
uint8_t Sym_Grad[3] = {0x03, 0x03, 0x00};                               // .
uint8_t Sym_SmallA[5] = {0x32, 0x4A, 0x4A, 0x7E, 0x00};                 // a


SymbolType HexSym[19] = {
{	6,	8,	Sym_0},	{	6,	8,	Sym_1},	{	6,	8,	Sym_2},	{	6,	8,	Sym_3},
{	6,	8,	Sym_4},	{	6,	8,	Sym_5},	{	6,	8,	Sym_6},	{	6,	8,	Sym_7},
{	6,	8,	Sym_8},	{	6,	8,	Sym_9},	{	6,	8,	Sym_A},	{	6,	8,	Sym_B},
{	6,	8,	Sym_C},	{	6,	8,	Sym_D},	{	6,	8,	Sym_E},	{	6,	8,	Sym_T},
{   2,  8,  Sym_Point}, {   2,  8,  Sym_Grad}, {   5,  8,  Sym_SmallA}
};
